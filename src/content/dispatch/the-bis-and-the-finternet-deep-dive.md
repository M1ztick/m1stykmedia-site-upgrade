...
The founding shareholders were the central banks of:
- Belgium
- France
- Germany
- Italy
- Japan
- United Kingdom
- United States (represented by banking groups, not the Federal Reserve directly at first)
- Switzerland (as host)
...
- In early 1939, the BIS **transferred Czechoslovakian national gold reserves to Nazi Germany's Reichsbank** after the German occupation of Czechoslovakia.
- Throughout the war, BIS board meetings continued in Basel with representatives from both Allied and Axis central banks in attendance—including **Hjalmar Schacht**, Hitler's Reichsbank president, and **Montagu Norman**, Governor of the Bank of England.
- The BIS facilitated **gold shipments from Europe to New York**, often on behalf of central banks from occupied nations.

At the end of the war, the Allies initially agreed to **shut the BIS down**. The plan was abandoned, partly at the urging of **John Maynard Keynes**, who argued the institution would be needed for postwar monetary reconstruction. The BIS survived—one of the few Nazi-era institutions to emerge intact and ultimately more powerful.
...
| **Asia** | 16 | People's Bank of China, Bank of Japan, Reserve Bank of India, Bank of Korea, Monetary Authority of Singapore |
| **South America** | 5 | Central Bank of Brazil, Bank of Mexico, Central Bank of Argentina, Central Bank of Chile, Central Bank of Colombia |
| **North America** | 3 | Federal Reserve (U.S.), Federal Reserve Bank of New York, Bank of Canada |
...
- These six may jointly appoint **one additional director** from among their own central banks.
- The remaining **11 directors** are elected by the broader membership from other member central banks.

**Current General Manager**: **Pablo Hernández de Cos** (as of 2025), preceded by **Agustín Carstens** (2017–2025), former Governor of the Bank of Mexico.

The BIS operates with approximately **1,300 staff** from across its member jurisdictions, functioning under Swiss law but with **diplomatic immunity** protections for its personnel and assets.
...
- **G20 nations have committed** to implementing Basel standards.
- The **IMF and World Bank** incorporate Basel compliance into their lending conditions.
- **Credit rating agencies** factor Basel compliance into sovereign and bank ratings.
- Markets **penalize non-compliance** through higher funding costs.
...
- **Exclusive** (only member central banks and invited observers)
- **Influential** (discussions shape subsequent policy announcements worldwide)
...
- **Working papers** on monetary policy, financial stability, and digital currencies
- **Statistical databases** (BIS Statistics) tracking global banking flows, derivatives, and debt securities
- **The Quarterly Review** and **BIS Bulletin**
...
- **Short-term bridging loans** to central banks in distress
- **Asset management** for central bank reserves
...
- **Tokenized assets and unified ledgers**
- **AI-driven financial supervision**
- **Cyber resilience frameworks**

The Innovation Hub operates centers in **Basel, Hong Kong, London, Singapore, Stockholm, and Switzerland**, running collaborative experiments with member central banks.
...
|---------|---------|----------|--------|
| **Project mBridge** | Multi-CBDC platform for instant cross-border payments | PBOC (China), HKMA, Bank of Thailand, CBUAE, Saudi Central Bank | **Minimum Viable Product reached mid-2024** |
| **Project Helvetia** | Wholesale CBDC integration with existing systems | Swiss National Bank, SIX Digital Exchange | Completed |
| **Project Aurum** | Two-tier retail CBDC architecture | HKMA, BIS HK Centre | Ongoing |
| **Project Rosalind** | Retail CBDC via open API ecosystem | BIS London Centre, Bank of England | Ongoing |
| **Project Polaris** | Cyber resilience for retail CBDCs | Multiple central banks | Ongoing |
| **Project Nexus** | Interconnectionof domestic payment systems | Multiple Asian central banks | Ongoing |
| **Project Jura/Dunbar** | Multi-CBDC common platforms | France, Singapore, Switzerland, Australia, Malaysia, South Africa | Completed proof-of-concept |
| **Project Mariana** | Automated FX market-making using CBDCs | BIS, multiple central banks | Ongoing |

**Project mBridge** is particularly significant. It envisions a shared platform where **multiple central banks can issue and exchange their respective CBDCs**, enabling instant cross-border settlement in central bank money. The platform is built on a **permissioned distributed ledger** compatible with the Ethereum Virtual Machine. The Saudi Central Bank joined in 2024, signaling potential expansion across the Gulf and broader Global South.
...
2. **Unified Ledgers**: A common platform where:
   - Tokenized **central bank reserves** (wholesale CBDCs)
   - Tokenized **commercial bank deposits**
   - Tokenized **government bonds**
   - Tokenized **real-world assets**
   ...all interact seamlessly and settle **instantly and atomically**.

3. **Programmability**: Money and assets that execute automatically based on predefined conditions. This enables:
   - Conditional payments (e.g., funds released only upon delivery)
...
|-----------|---------------|
| **Interoperability** | Different systems and ledgers must communicate seamlessly |
| **Verifiability** | All transactions and asset claims must be cryptographically verifiable |
| **Programmability** | Smart contracts automate execution without manual intervention |
| **Immutability** | Transaction records cannot be altered after settlement |
| **Finality** | Once settled, transactions are irreversible |
| **Evolvability** | The system can adapt and upgrade without disruption |
...
This **"trilogy"**—tokenized central bank reserves, tokenized commercial bank money, and tokenized government bonds—represents the foundational layer upon which all other financial services would be built.
...
1. **Speed**: Cross-border payments currently take 2–5 days; the Finternet promises **instant settlement**.
2. **Cost**: Remittance fees average 6.2% globally; the Finternet aims for **near-zero marginal costs**.
3. **Inclusion**: 1.4 billion adults remain unbanked; the Finternet could provide **universal access** via digital identity.
...
1. **Absolute Control**: In a widely circulated 2021 speech, Agustín Carstens stated explicitly:
   ...
   This was not a gaffe—it was a candid description of what programmable money enables.

2. **Surveillance Architecture**: Every transaction on a unified ledger leaves a permanent, immutable record. While the BIS promises "privacy-protected" design, the default architecture is **total visibility** to the issuing authority and system operators.

3. **Programmable Restrictions**: Money that can be programmed can also be:
   - **Restricted** to specific merchant categories
   - **Time-limited** (expires if not spent by a deadline)
   - **Conditional** on behavioral criteria or social scores
   - **Frozen** instantly and comprehensively
   - **Geofenced** to specific jurisdictions

4. **Financial Exclusion in Reverse**: While proponents tout inclusion, the same architecture enables **exclusion at scale**—any individual or entity can be severed from the financial system algorithmically, without physical intervention.
...
| Current State | Finternet State |
|---------------|-----------------|
| Cash: anonymous, untraceable | CBDCs: every transaction recorded permanently |
| Bank data fragmented across institutions | Unified ledger: comprehensive financial profile |
...
- **Helicopter money with conditions**: stimulus funds that expire if unspent
- **Negative interest rates enforced directly**: no hiding in cash
...
- **Corporations** operate on permissioned ledgers where compliance is automated
...
| BIS-Aligned Finternet | Alternative Systems |
|-----------------------|---------------------|
| Programmable CBDCs | Cryptocurrencies (Bitcoin, privacy coins) |
| Unified ledgers | Decentralized, permissionless blockchains |
| Identity-linked transactions | Anonymous or pseudonymous systems |
| Automated compliance | Censorship-resistant protocols |
| Central bank control | Algorithmic or community governance |
...
| **India** | Active development | Digital Rupee; UPI expansion; Nilekani's influence |
| **European Union** | Preparation phase | Digital Euro investigation; ECB experimentation |
| **United Kingdom** | Research phase | Bank of England "Britcoin" consultations |
| **United States** | Cautious study | FedNow launched; retail CBDC politically contested |
| **Brazil** | Active development | Drex (Digital Real) pilot with tokenized government bonds |
| **Nigeria** | Launched | eNaira (limited adoption) |
| **Jamaica** | Launched | JAM-DEX (first CBDC in Caribbean) |
...
2. **Can privacy promises be trusted?** Carstens's statement about "absolute control" contradicts assurances of user privacy. Technology that enables control will eventually be used for control.

3. **What happens when the system fails?** Unified ledgers represent single points of failure. A systemic outage, cyberattack, or software bug could freeze entire economies.

4. **Will nation-states surrender monetary sovereignty?** The BIS vision requires standardized interoperability. Will the U.S., China, or EU accept BIS-defined standards for their domestic currencies?

5. **Is the "inclusion" framing accurate?** India's Aadhaar brought hundreds of millions into the banking system—but also created one of the world's most comprehensive surveillance infrastructures. Is the Finternet inclusion or enclosure?
...
In the 20th century, central banks controlled the **supply** of money. In the 21st century, the Finternet would give them control over the **function** of money—who can use it, for what, when, where, and under what conditions.

Agustín Carstens was unusually candid: **the technology to enforce absolute control exists**. The question for the next generation is whether that control will be exercised with restraint, and who—if anyone—will have the power to check it.

The BIS has spent nearly a century building the infrastructure of global finance. The Finternet may be its final, most consequential construction. What gets built in Basel over the next decade will shape whether money remains a tool of human freedom or becomes a mechanism of algorithmic governance.

The 63 central banks are already inside. The rest of humanity will be asked—or required—to join.
